...
background_music = "TMusic.mp3"
click_effect = pygame.mixer.Sound("Minecraft.mp3")
...
def play_background_music():
   pygame.mixer.music.load(background_music)      #repeat this song
...
def show_question_window():
    ...
    Text(q_win, text="Now answer these questions:")
...
def info_DongTa():
    window = Window(app, title="About East Pagoda", width=740, height=400)
...
def info_Liu():
    window = Window(app, title="About Liu Ji", width=800, height=400)
...
def info_Ojiang():
    window = Window(app, title="About Oujiang River", width=800, height=400)
...
def info_Nuomifan():
    window = Window(app, title="About Local Cuisine", width=800, height=400)
